...
- `theory-framework.json` có outline phụ `m_p07` và 8 mục `m_p07_t01`–`t08`; đây chỉ là ứng viên dàn ý chưa có full content, không phải chapter/bài vật lý hoặc runtime-ready.
