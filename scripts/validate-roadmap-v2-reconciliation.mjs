...
assert.equal(manifest.separateWork?.mergeIntoRecoveryNow,false,'Foundation L10 recovery ownership must remain disabled');
assert.equal(fs.existsSync('recovery/roadmap-v2/foundation/content-registry'),false,'Foundation L10 must stay outside recovery-owned paths');
