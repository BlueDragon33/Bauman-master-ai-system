...
(function(){
  ...
  function clearFromUi(courseId,code){if(!window.confirm('Xóa readiness evidence của '+courseId+' · '+code+'? Thao tác này không thể hoàn tác.'))return;clearEvidence(courseId,code);openEvent(courseId,code)}
