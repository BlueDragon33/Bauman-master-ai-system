...
function normalizeState(raw){
  ...
  const journal=(src.deepStudyJournal&&typeof src.deepStudyJournal==='object')?src.deepStudyJournal:{};
  out.deepStudyJournal={version:1,feynman:Array.isArray(journal.feynman)?journal.feynman.slice(-200):[],errors:Array.isArray(journal.errors)?journal.errors.slice(-500):[],closedAi:Array.isArray(journal.closedAi)?journal.closedAi.slice(-100):[],oralDefense:Array.isArray(journal.oralDefense)?journal.oralDefense.slice(-200):[]};
  return out;
}
