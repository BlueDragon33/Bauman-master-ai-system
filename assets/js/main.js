...
function capabilityContextFromTask(task=state.activeTask){
 const route=compactSubjectRoute(task?.capabilityRoute);
 if(!task||task.subjectId!=='russian'||task.source!=='capability-gap'||!route)return null;
