...
- Last completed: `Lượt 30 / Bước 120`.
- Next gate: `Lượt 31 / Bước 121 — NOT_STARTED`.
- Status: `PASS_B117_B120_CURRICULUM_RECONCILIATION_V2_1_READ_ONLY`.
...
- Next: open L31/B121 for full Main/8-module UI audit.
