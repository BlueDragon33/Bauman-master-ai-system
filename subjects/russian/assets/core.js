...
function startLineRecording(){
 ...
 rec.onstart=()=>{if(token!==speechRecognitionToken)return;state.speechRecording=true;save();render();notifySpeakingRecordingStarted(d,idx);toast('Đang nghe tiếng Nga của bạn...')};
