...
window.SUBJECT_ADAPTER = {
  ...
  ui: {
    ...
    logo: 'Я',
    title: 'Tiếng Nga',
    fullTitle: 'Tiếng Nga · Nghe • Nói • Đọc • Viết',
    subtitle: 'Nghe • Nói • Đọc • Viết',
    coreLabel: 'RUSSIAN SURVIVAL MASTER V13.24 GRAMMAR MIND MAP LUXE',
    heroBadge: 'Russian Bauman Survival Master · V12.73 Bonus Total QA Polish',
    ...
    assistantToast: 'AI trợ lý Tiếng Nga đã sẵn sàng: từ phát âm cơ bản đến giao tiếp học thuật.',
    stageLabel: 'Giai đoạn',
    overviewSubtitle: 'Tổng quan gọn: phát âm, chữ cái, từ vựng, ngữ pháp, luyện chữ và hội thoại trong một màn hình.',
    learningSubtitle: '2 tháng đầu: Nghe/Nói và Video/Audio là trục chính. V13.24 thêm Ngữ pháp riêng và Mind map để ôn sâu mà không rối.',
