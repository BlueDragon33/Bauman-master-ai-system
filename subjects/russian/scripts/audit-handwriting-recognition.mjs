...
const checks=[
  ...
  ['blocked authority is explicit by default', authority.includes("status:'blocked'") && authority.includes("source:'none'") && authority.includes('trustedFamilies:Object.freeze([])')],
  ['scoring requires vetted bundled authority metadata', recognition.includes("authority.status==='ready'") && recognition.includes("authority.source==='bundled-vetted'") && recognition.includes('!!authority.asset') && recognition.includes('!!authority.license') && recognition.includes('!!authority.verifiedAt') && recognition.includes('authority.trustedFamilies.includes(font)')],
