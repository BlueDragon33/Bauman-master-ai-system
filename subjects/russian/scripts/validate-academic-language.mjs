...
const coach=html.indexOf('assets/speaking-coach.js'), academic=html.indexOf('assets/academic-language.js'), ui=html.indexOf('assets/russian-future-ui.js');
if(!(coach>=0&&academic>coach&&ui>academic))throw new Error('Academic language bridge must load after speaking coach and before canonical Future UI');
