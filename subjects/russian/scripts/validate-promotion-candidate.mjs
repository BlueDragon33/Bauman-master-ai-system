...
const runtimeJs=['assets/core.js','assets/learning-state.js','assets/learning-flow.js','assets/vocab-srs.js','assets/speaking-coach.js','assets/academic-language.js','assets/ai-mentor-guard.js','assets/runtime-optimizer.js','assets/russian-future-ui.js','assets/ui-cleanup-contract.js'].map(read).join('\n');
...
console.log('Checks: no runtime backups, stable canonical load order, legacy UI version labels neutralized before core render, canonical resume/review/SRS/academic storage preserved, AI read-only, Russian-scoped offline shell, responsive runtime status, no destructive storage reset.');
