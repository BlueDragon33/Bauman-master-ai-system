...
console.log('Checks: read-only AI context, no AI mastery mutation, scoped service worker, user-initiated full offline cache, Save-Data guard, responsive runtime status.');
