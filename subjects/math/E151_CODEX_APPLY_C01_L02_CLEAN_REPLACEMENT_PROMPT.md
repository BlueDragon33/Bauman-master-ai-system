# E151 · Codex apply clean C01 L02 replacement prompt

Use this prompt in Codex to apply the clean UTF-8 §1.2 replacement prepared by ChatGPT.

```text
Continue from CODEX_STATE.md on branch codex/e150-c01-l01-clean-replacement.

Task: E151 apply clean UTF-8 replacement for C01 §1.2.
...
const replPath = 'subjects/math/data/theory_lecture_content_c01_l02_e151_clean_replacement.json';
const targetId = 'MATH-VN-C01-vector_trong_khong_gian_-L02-norm-distance-metric-e139';
...
Report:
- Create subjects/math/E151_C01_L02_CLEAN_REPLACEMENT_REPORT.md
