/* E218 Reader Pro adaptive typography + fit guard. */
(function(){
  'use strict';
  var RELEASE='E218_READER_PRO_COMPACT_TITLES_FORMULA_FIT';
  var last='';
  ...
  function ensureStyle(){
    if(document.getElementById('e218-reader-fit-style'))return;
    ['e215-reader-fit-style','e216-reader-fit-style','e217-reader-fit-style'].forEach(function(id){
    ...
    var css=''
      ...
      +'.e132-overlay-deck.open.e211-reader-pro .e202-formula-strip{max-width:100%!important;padding:7px 9px!important;margin-top:2px!important;grid-template-columns:auto minmax(0,1fr) auto!important;gap:8px!important;align-items:start!important}'
      +'.e132-overlay-deck.open.e211-reader-pro .e202-formula-strip b{font-size:10.5px!important;line-height:1.2!important}'
      +'.e132-overlay-deck.open.e211-reader-pro .e202-formula-strip code{display:block!important;max-height:58px!important;overflow:auto!important;white-space:pre-wrap!important;overflow-wrap:anywhere!important;font-size:clamp(12px,.86vw,14px)!important;line-height:1.28!important;-webkit-line-clamp:unset!important;scrollbar-width:thin}'
      +'.e132-overlay-deck.open.e211-reader-pro .e211-formula-full-btn{align-self:start!important;font-size:11px!important;padding:7px 9px!important}'
      ...
      +'.e132-overlay-deck.open.e211-reader-pro .e202-visual .e202-tag{font-size:10.5px!important;line-height:1.1!important;padding:5px 8px!important}'
      +'.e132-overlay-deck.open.e211-reader-pro .e211-extension-panel .e211-panel-role{font-size:9.5px!important;line-height:1.1!important;margin:0!important}'
      +'.e132-overlay-deck.open.e211-reader-pro .e211-extension-panel h3{font-size:clamp(10.5px,.68vw,13px)!important;line-height:1.16!important}'
      +'.e132-overlay-deck.open.e211-reader-pro .e211-extension-panel .e211-slide-name{font-size:clamp(12px,.82vw,15px)!important;line-height:1.2!important}'
      ...
      +'.e132-overlay-deck.open.e211-reader-pro .e211-extension-panel.is-light .e211-slide-name{font-size:clamp(13px,.95vw,17px)!important}'
      +'.e132-overlay-deck.open.e211-reader-pro .e211-extension-panel.is-dense .e211-summary-lead{font-size:clamp(13px,.9vw,15.5px)!important;line-height:1.34!important}'
      +'.e132-overlay-deck.open.e211-reader-pro .e211-extension-panel.is-overflow .e211-summary-lead{font-size:clamp(12.5px,.84vw,14.2px)!important;line-height:1.3!important}'
      ...
      +'.e132-overlay-deck.open.e211-reader-pro .e132-clean-card h3{font-size:clamp(11.5px,.74vw,14px)!important;line-height:1.16!important;margin:0!important;overflow-wrap:anywhere}'
      ...
      +'.e132-overlay-deck.open.e211-reader-pro .e132-clean-card[data-e212-density="light"] h3{font-size:clamp(12.5px,.82vw,15.5px)!important}'
      ...
      +'.e132-overlay-deck.open.e211-reader-pro .e132-card-kicker{font-size:9px!important;padding:3px 6px!important;margin-bottom:4px!important}'
