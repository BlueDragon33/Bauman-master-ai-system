...
(function(){
  ...
  var REGISTRY={
    ...
    'MATH-VN-C01-vector_trong_khong_gian_-L06-vector-to-data-matrix-e140':{
      ...
      slideshow:{id:'theory_slideshow_c01_l06',label:'Slideshow richness · §1.6',path:'data/theory_slideshow/theory_slideshow_c01_l06.json',version:'SLIDESHOW_C01_L06_V1_PASS13',expected:{slides:22,diagrams:11,retrievalChecks:22,misconceptions:22}}
    }
  };
