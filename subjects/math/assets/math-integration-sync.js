...
(function mathIntegrationSync(global){
  ...
  function refresh(){
    ...
    call(()=>global.BAUMAN_MATH_STUDY_COMMAND_CENTER?.refresh?.());
  ...
  function bind(){
    document.addEventListener('click',e=>{
      if(e.target.closest('[data-e129-chapter],[data-e129-lesson],[data-e129-stage],[data-e129-nav],[data-e169-pick-activity],[data-e169-pick-lesson],[data-e129-back-theory],[data-e129-refresh],[data-math-nav],[data-lf-step],[data-study-open],[data-activity-action],[data-am-state],[data-scc],[data-fl],[data-fl-index],[data-pd]'))schedule(220);
    },true);
  ...
  function selfCheck(){return{release:RELEASE,runs,mutationObserver:false,routeOwnership:false,academicWrites:false,targets:['role-map','workspace','premium','dashboard','navigation','learning-flow','activity-studio','activity-mastery','study-command-center','formula-library','formula-context','simulation-source','professor-drill','study-library']}}
